...
public abstract class AbstractDAOTemplate {
    ...
    /** user customized SuperClass **/
    private String customizedSuperClass;
    ...
    public void setCustomizedSuperClass(String customizedSuperClass) {
        this.customizedSuperClass = customizedSuperClass;
    }

    public String getCustomizedSuperClass() {
        return customizedSuperClass;
    }
}
