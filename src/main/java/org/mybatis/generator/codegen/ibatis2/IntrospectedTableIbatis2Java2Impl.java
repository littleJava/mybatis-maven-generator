...
public class IntrospectedTableIbatis2Java2Impl extends IntrospectedTable {
    ...
    protected void calculateDAOGenerators(List<String> warnings,
        ...
        Properties daoProperties = context.getJavaClientGeneratorConfiguration().getProperties();
        ...
        if (javaGenerator instanceof DAOGenerator) {
            ((DAOGenerator)javaGenerator).setDaoProperties(daoProperties);
        }
